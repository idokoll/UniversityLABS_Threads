...
public abstract class MicroService implements Runnable {
    ...
    public MicroService(String name) {
        ...
        messageCallbacks = new ConcurrentHashMap<Class<? extends Message>, Callback>();
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message currMsg = msg.awaitMessage(this);
                messageCallbacks.get(currMsg.getClass()).call(currMsg);
